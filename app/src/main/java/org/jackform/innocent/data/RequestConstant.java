...
public interface RequestConstant {
    ...
    int REQUEST_GET_PERSONAL_INFO = REQUEST_BASE + 8;
    int REQUEST_UPDATE_PERSONAL_INFO = REQUEST_BASE + 9;
    int REQUEST_SEARCH_USER_LIST = REQUEST_BASE + 10;
    int REQUEST_ADD_FRIEND = REQUEST_BASE + 11;
